...
// }
  ...
  render() {
   // this.updateDataFields();
    return (
      <div>
        <Modal className = "ant-modal-manual"
        ...
        >
         {/* <Input placeholder="Section Detail Types" value = {this.state.sectionDetailTypeText} onChange={this.handleOnChange} /> &nbsp;&nbsp;&nbsp; */}
          <Table  dataSource={this.state.dataFields} columns={columns}  pagination = {false}>
          </Table>
        </Modal>
